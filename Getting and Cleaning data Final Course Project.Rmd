...
-------------------------------------------------------------------------------
# 2. Merging data from the train and the test datasets to create one data set  (In the following the word data means both train and test). The x_data.txt, y_data.txt, subject_data.txt should be binded by row.
...
# 5.Setting descriptive activity names to name the activities in the data set.
